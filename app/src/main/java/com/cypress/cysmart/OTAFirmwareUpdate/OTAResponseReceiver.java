...
public class OTAResponseReceiver extends BroadcastReceiver {
    ...
    private String TAG="OTAResponseReceiver";
    ...
    public void onReceive(Context context, Intent intent) {
         ...
         */
        if (ACTION_OTA_DATA_AVAILABLE.equals(action)) {
            ...
            if ((Utils.getStringSharedPreference(mContext, Constants.PREF_BOOTLOADER_STATE))
                ...
                Log.e(TAG, "In Receiver Exit " + Utils.getStringSharedPreference(mContext, Constants.PREF_BOOTLOADER_STATE));
                parseExitBootloader(hexValue);
            } else {
                Log.i(TAG, "In Receiver No case " + Utils.getStringSharedPreference(mContext, Constants.PREF_BOOTLOADER_STATE));
            }
        }
    }
    ...
    private void parseExitBootloader(String parse) {
        ...
        Log.i(TAG, "RESPONSE EXIT>> " + response);
        int reponseBytes = Integer.parseInt(response, 16);
        switch (reponseBytes) {
            case 0:
                Log.i(TAG, "CYRET_SUCCESS");
